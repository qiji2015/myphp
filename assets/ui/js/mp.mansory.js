(function ( $ ) {
	...
	$.fn.mpmansory = function ( options ) {
		...
		$.fn.apply = function ( settings, nrOfColumns, wrappers, items ) {
			...
			var classStr = "layui-col-lg" + settings.breakpoints.lg + " layui-col-md"+settings.breakpoints.md + " layui-col-sm" + settings.breakpoints.sm + " layui-col-xs" + settings.breakpoints.xs + " " + settings.columnClasses;
